package registerCourier;

import initialization.MainTests;
...
public class RegisterCourierWithoutRequiredFieldsParameterizedTests extends MainTests {

    private Courier courierWithoutFields;

    public RegisterCourierWithoutRequiredFieldsParameterizedTests(Courier courierWithoutFields) {
    ...
    public static Object[][] getCourierData() {
        return new Object[][]{
                ...
                {new Courier(RandomStringUtils.randomAlphabetic(10),RandomStringUtils.randomAlphabetic(10), null)}
        };
    }
